...
alias yac="yadm add ~/.github/ ~/.config/alacritty/ ~/.config/git/ ~/.config/helix/ ~/.config/homebrew/ ~/.config/kitty/ ~/.config/lang/ ~/.config/npm/ ~/.config/nvim/ ~/.config/shell/ ~/.config/tmux/ ~/.config/wezterm/ ~/.config/yadm/"
