...
alias yac='yadm add ~/.config/alacritty/ ~/.config/ghostty/ ~/.config/git/ ~/.config/helix/ ~/.config/kitty/ ~/.config/lang/ ~/.config/lazygit/ ~/.config/mise/ ~/.config/npm/ ~/.config/nvim/ ~/.config/shell/ ~/.config/shellcheckrc ~/.config/tmux/ ~/.config/vim/ ~/.config/wezterm/ ~/.config/yadm/ ~/.ssh/config ~/.ssh/config.d/00-git.conf ~/docs/ ~/.zshenv ~/.zshrc'
