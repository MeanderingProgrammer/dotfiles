...
alias yac='yadm add ~/.config/alacritty/ ~/.config/bin/ ~/.config/fish/ ~/.config/ghostty/ ~/.config/git/ ~/.config/helix/ ~/.config/kitty/ ~/.config/lazygit/ ~/.config/mise/ ~/.config/npm/ ~/.config/nvim/ ~/.config/shellcheckrc ~/.config/tmux/ ~/.config/vim/ ~/.config/wezterm/ ~/.config/yadm/ ~/.config/zsh/ ~/.ssh/config ~/.ssh/config.d/00-git.conf ~/docs/ ~/.zshenv ~/.zshrc'
